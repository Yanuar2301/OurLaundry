			...
			<div class="card-header">
				<div class="row">
					...
					<div class="col-sm-6 text-right">
						<a href="?hal=member&aksi=Tambah" class="btn btn-sm btn-success mb-3">
				...
				<table class="table tablesorter">
					...
					<tbody align="center">
						...
						<tr>
							...
							<td>
								<a href="?hal=member&aksi=Ubah&id=<?php echo $data['id']; ?>" class="btn btn-sm btn-warning">
									<i class="tim-icons tim-icons-lg icon-pencil"></i>
								</a>
								&nbsp;
								<a href="?hal=member&aksi=Hapus&id=<?php echo $data['id']; ?>" class="btn btn-sm btn-danger">
