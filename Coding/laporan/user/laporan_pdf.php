...
class myPDF extends FPDF{
    function header(){
        ...
        $this->Cell(276,10,'DATA USER',0,0,'C');
        $this->Ln(20);
    }
    function footer(){
        $this->SetY(-15);
    ...
    function headerTable(){
        ...
        $this->Cell(80,10,'ID Outlet',1,0,'C');
        $this->Cell(90,10,'Role',1,0,'C');
        $this->Ln();
    }
    function viewTable($dbh){
        ...
        foreach ($query as $data) {
            ...
            $this->Cell(60,10,$data['username'],1,0,'L');
            $this->Cell(70,10,$data['password'],1,0,'L');
            $this->Cell(80,10,$data['id_outlet'],1,0,'L');
            $this->Cell(90,10,$data['role'],1,0,'L');
            $this->Ln();
