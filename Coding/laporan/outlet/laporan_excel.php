...
$namaFile = "LAPORAN DATA OUTLET.xls";
...
foreach($hasil as $data){
   ...
   // menampilkan data nama outlet
   xlsWriteLabel($noBarisCell,2,$data['nama_outlet']);

   // menampilkan data alamat
   xlsWriteLabel($noBarisCell,3,$data['alamat']);

   // menampilkan data tlp
   xlsWriteLabel($noBarisCell,4,$data['tlp']);
