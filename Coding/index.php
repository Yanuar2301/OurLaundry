	      	...
	      	<div class="sidebar-wrapper">
	        	<div class="logo">
		          ...
		          <li class="<?php echo	isset($_GET['hal']) && $_GET['hal'] == 'member' ? 'active' : ''; ?>">
		            ...
		            <li class="<?php echo isset($_GET['hal']) && $_GET['hal'] == 'detailtransaksi' ? 'active' : ''; ?>">
		            <a href="?hal=detailtransaksi">
					<i class=""></i>
		              <p>DETAIL TRANSAKSI</p>
		            </a>
		          </li>

		      	  <li class="<?php echo	isset($_GET['hal']) && $_GET['hal'] == 'paket' ? 'active' : ''; ?>">
		            <a href="?hal=paket">
					<i class=""></i>
		              <p>DATA PAKET</p>
		            </a>
		          ...
		          <li class="<?php echo	isset($_GET['hal']) && $_GET['hal'] == 'user' ? 'active' : ''; ?>">
		            <a href="?hal=user">
		              <i class=""></i>
		              <p>DATA USER</p>
		            </a>
